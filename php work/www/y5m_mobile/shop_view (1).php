...
<ul>
<li>
<?php $ls_id=$_GET['ls_id'];
$result =  mysqli_query($con,"SELECT * FROM tbl_ls where ls_id=".$ls_id);
while($row = mysqli_fetch_array($result))
echo "<a href='about_shop.php?ls_id=".$ls_id."'> About ".$row['ls_name']." </a>";
?>
</li>
<div class="clear"> </div>
</ul>
...
$result =  mysqli_query($con,"SELECT * FROM tbl_message where ls_id=".$_GET['ls_id']." ORDER BY msg_id DESC");
$flag=false;
while($row = mysqli_fetch_array($result))
  {
