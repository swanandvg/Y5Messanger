...
class tc_calendar{
	...
	public $icon;
	public $objname;
	public $txt = "Select"; //display when no calendar icon found or set up
	public $date_format = 'd-M-Y'; //format of date shown in panel if $show_input is false
	public $year_display_from_current = 30;
	...
	public $startDate = 0; //0 (for Sunday) through 6 (for Saturday)

	public $time_allow1 = false;
	public $time_allow2 = false;
	public $show_not_allow = false;
	...
	public $v_align = "bottom";
	public $h_align = "right";
	public $line_height = 18; //for vertical align offset

	public $date_pair1 = "";
	public $date_pair2 = "";
	public $date_pair_value = "";

	public $sp_dates = array(array(), array(), array()); //array[0]=no recursive, array[1]=monthly, array[0]=yearly
	public $sp_type = 0; //0=disabled specify date, 1=enabled only specify date
	...
	public $interval = 1; //date selected interval, default 1 day

	public $auto_hide = 1;
	public $auto_hide_time = 1000;

	public $mydate;
	public $warning_msgs = array();

	//Tooltips
	public $tt_dates = array(array(), array(), array()); //array[0]=no recursive, array[1]=monthly, array[0]=yearly
	public $tt_tooltips = array(array(), array(), array()); //array[0]=no recursive, array[1]=monthly, array[0]=yearly
